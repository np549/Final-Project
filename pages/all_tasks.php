...
<div style="width:100%;">
    ...
    <div style="width:70%; margin:0 auto; color:#FFF; background-color:#333; height:80px;">
        <div style="width:40%; float:left;">
            <h1><?php //this how to print some data;
                 echo "<a href='index.php' style='text-decoration:none; color:#fff;'>".'Mysite'."</a>";?> 
            </h1>
        </div>
    ...
    <div style="width:70%; margin:0 auto;">
    	 <h1>All Task</h1>
         <h1><a href="index.php?page=tasks&action=create" style="color:#333; font-size:26px; text-decoration:underline;">Add New Task</a></h1>

<?php
//this is how you print something
if($data!=null)
{
print utility\htmlTable::genarateTableFromMultiArray($data,'tsk');
}
